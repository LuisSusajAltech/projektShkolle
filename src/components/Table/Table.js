...
const ChakraUITable = ({ columns, data, options = defaultOptions, size = "sm", variant = "simple", screenWidth, ...rest }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
    ...
    return (
        <Flex w="100%" direction="column" >
            {screenWidth < 1020 ? <style>{'body{min-width:1020px;}'}</style> : null}
